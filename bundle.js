...
//MAKE A TAB THAT WONT LOSE FOCUS
...
d3.select("#hidden-file-upload").on("change", function () {
    if (window.File && window.FileReader && window.FileList && window.Blob) {
        ...
        filereader.onload = function () {
            ...
            try {
                var parsedData = d3.csvParseRows(txtRes);
                ...
                document.getElementById('results').innerHTML = typeof txtRes;
            } catch (err) {
        ...
        alert("something screwy happened with the browser");
    }
...
function makeTable(csvTable) {

    //format the table
    d3.text(csvTable, function (data) {
...
//    var contents = document.getElementById('inputfile');
//    var upload = document.getElementById('inputfile').value;
//    if (!regEx.test(upload.toLowerCase())) {
//        console.log("invalid file");
//        document.getElementById('status').innerHTML = "Error - Please upload a .csv file";
//        return false;
//    } else {
//        console.log("valid file");
//        document.getElementById('status').innerHTML = "CSV file detected.";
